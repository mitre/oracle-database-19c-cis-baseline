...
procedures. Enabling the option causes auditing of all such activities."
  desc  'rationale', "Dropping procedures of another user could be part of a
privilege escalation exploit and should be audited."
  desc  'check', "
