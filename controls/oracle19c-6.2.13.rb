...
action audit causes logging of all `ALTER DATABASE` and `ALTER PUBLIC DATABASE`
...
of the privileges held by the users to issue such statements."
  desc  'rationale', "Logging and monitoring of all attempts to alter database
...
involving alteration of database links."
  desc  'check', "
