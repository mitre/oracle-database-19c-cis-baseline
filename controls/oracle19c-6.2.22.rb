control 'oracle19c-6.2.22' do
  title "Ensure the 'DROP PROCEDURE/FUNCTION/PACKAGE/PACKAGE BODY' Action Audit
Is Enabled"
...
logging of all `DROP PROCEDURE`, `DROP FUNCTION`, `DROP PACKAGE` or `DROP
...
regardless of the privileges held by the users to issue such statements."
  desc  'rationale', "Logging and monitoring of all attempts, whether
successful or unsuccessful, to drop procedures, functions, packages or package
bodies may provide forensic evidence about potential suspicious/unauthorized
...
may require logging of all user activities involving dropping procedures,
functions, packages or package bodies."
  desc  'check', "
...
PACKAGE','DROP PACKAGE BODY' )
  ...
  describe 'Ensure DROP PROCEDURE/FUNCTION/PACKAGE/PACKAGE BODY audit option is enabled -- DROP PROCEDURE/FUNCTION/PACKAGE/PACKAGE BODY Action Audit' do
    subject { parameter }
    it { should be_empty }
  end
end
